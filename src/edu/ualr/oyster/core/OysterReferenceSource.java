...
public class OysterReferenceSource {
    ...
    /*START MODIFICATION PABLO MAZZUCCHI*/
    /** The connection endPoint */
    private static String endPoint = null;
    
    /**The prefix for sparql query*/
    private static String prefix = null;
    /*END MODIFICATION PABLO MAZZUCCHI*/
    ...
    /*START MODIFICATION PABLO MAZZUCCHI*/
    /**
     * Returns the endPoint for this <code>OysterReferenceSource</code>.
     * @return the endPoint to be returned.
     */    
    ...
    /**
     * Sets the endPoint for this <code>OysterReferenceSource</code>.
     * @param aEndPoint the endPoint to be set.
     */
	...
	/**
     * Returns the prefix for this <code>OysterReferenceSource</code>.
     * @return the prefix to be returned.
     */ 
	...
	/**
     * Sets the prefix for this <code>OysterReferenceSource</code>.
